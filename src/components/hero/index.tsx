    ...
    <ChatProvider>
      <header className="relative">
        ...
        <div className="flex flex-col md:grid md:grid-cols-3 justify-end pt-[var(--top-bar)] w-full">
          <div className="w-full md:order-1 order-2 min-h-[calc(100vh-var(--top-bar))] md:h-available">
            <ChatInterface />
          </div>
          <div className="md:col-span-2 order-1 md:order-2 flex flex-col justify-end relative min-h-[calc(100vh-var(--top-bar))]">
